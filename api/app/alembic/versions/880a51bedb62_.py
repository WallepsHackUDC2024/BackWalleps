...
Revision ID: 880a51bedb62
Revises: 12bbda8e32e0
Create Date: 2024-02-17 20:33:59.717879
...
revision: str = '880a51bedb62'
down_revision: Union[str, None] = '12bbda8e32e0'
...
def upgrade() -> None:
    ...
    op.add_column('device', sa.Column('efficiency', sa.String(), nullable=True))
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('device', sa.Column('effiency', sa.VARCHAR(), autoincrement=False, nullable=True))
    op.drop_column('device', 'efficiency')
