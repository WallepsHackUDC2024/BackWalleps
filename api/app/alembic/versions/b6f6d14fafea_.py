...
Revision ID: b6f6d14fafea
Revises: 6cb3665ad6ab
Create Date: 2024-02-17 10:31:41.980984
...
revision: str = 'b6f6d14fafea'
down_revision: Union[str, None] = '6cb3665ad6ab'
...
def upgrade() -> None:
    ...
    op.drop_column('device', 'daytime')
    # ### end Alembic commands ###


def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('device', sa.Column('daytime', sa.VARCHAR(), autoincrement=False, nullable=True))
