...
Revision ID: 6cb3665ad6ab
Revises: 37ec7add1073
Create Date: 2024-02-17 10:26:26.729419
...
revision: str = '6cb3665ad6ab'
down_revision: Union[str, None] = '37ec7add1073'
...
def upgrade() -> None:
    ...
    op.add_column('device', sa.Column('model', sa.String(), nullable=True))
    op.add_column('device', sa.Column('brand', sa.String(), nullable=True))
    op.add_column('device', sa.Column('effiency', sa.String(), nullable=True))

    op.create_index(op.f('ix_device_id'), 'device', ['id'], unique=False)
    op.add_column('user', sa.Column('home_hours', sa.Integer(), nullable=True))
    op.add_column('user', sa.Column('home_duration', sa.Integer(), nullable=True))
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('user', sa.Column('contract_type', sa.VARCHAR(), autoincrement=False, nullable=True))
    op.drop_column('user', 'home_duration')
    op.drop_column('user', 'home_hours')
    op.drop_index(op.f('ix_device_id'), table_name='device')
    op.alter_column('device', 'daytime',
               existing_type=sa.Integer(),
               type_=sa.VARCHAR(),
               existing_nullable=True)
    op.drop_column('device', 'effiency')
    op.drop_column('device', 'brand')
