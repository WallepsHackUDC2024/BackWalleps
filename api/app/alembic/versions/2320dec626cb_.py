...
Revision ID: 2320dec626cb
Revises: b6f6d14fafea
Create Date: 2024-02-17 10:32:15.605758
...
revision: str = '2320dec626cb'
down_revision: Union[str, None] = 'b6f6d14fafea'
...
def upgrade() -> None:
    ...
    op.add_column('device', sa.Column('daytime', sa.Integer(), nullable=True))
