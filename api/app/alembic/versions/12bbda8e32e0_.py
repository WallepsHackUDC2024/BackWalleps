...
Revision ID: 12bbda8e32e0
Revises: 2320dec626cb
Create Date: 2024-02-17 17:51:40.824966
...
revision: str = '12bbda8e32e0'
down_revision: Union[str, None] = '2320dec626cb'
...
def upgrade() -> None:
    ...
    op.add_column('user', sa.Column('is_sections', sa.Boolean(), nullable=True))
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('user', sa.Column('power', sa.INTEGER(), autoincrement=False, nullable=True))
    op.drop_column('user', 'is_sections')
